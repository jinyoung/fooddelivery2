...
from PolicyHandler import wheneverPaid_주문목록에추가
from PolicyHandler import wheneverOrderCanceled_주문취소알림
...
def consume(msg):
    ...
    if data['eventType'] == "Paid":
        wheneverPaid_주문목록에추가(data)
    if data['eventType'] == "OrderCanceled":
        wheneverOrderCanceled_주문취소알림(data)
